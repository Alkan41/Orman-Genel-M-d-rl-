...
const TabButton = ({ onClick, isActive, children }: TabButtonProps) => {
    const baseClasses = "py-3 px-4 rounded-lg text-sm sm:text-base transition-all duration-300 flex-1 text-center relative";
    const activeClasses = "bg-ogm-green-600 text-white shadow-md font-semibold";
    const inactiveClasses = "bg-stone-200 text-stone-800 hover:bg-stone-300 shadow-sm font-semibold";
    return (
