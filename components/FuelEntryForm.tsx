        ...
        <div className="space-y-6">
            ...
            <form onSubmit={e => e.preventDefault()}>
                ...
                <div className="flex justify-between gap-4 mt-6">
                    {currentStep > 1 && (
                        <button type="button" onClick={prevStep} className="flex-1 py-3 px-6 bg-slate-500 text-white rounded-lg font-semibold hover:bg-slate-600 transition-colors">Geri</button>
                    )}
                    {currentStep < maxSteps ? (
                        <button type="button" onClick={nextStep} disabled={!isStepValid(currentStep)} className="flex-1 py-3 px-6 bg-ogm-green-600 text-white rounded-lg font-semibold hover:bg-ogm-green-700 transition-colors disabled:bg-slate-300 disabled:cursor-not-allowed">İleri</button>
                    ) : (
                        <button type="button" onClick={handleSubmit} disabled={isSubmitting || !isStepValid(currentStep)} className="flex-1 py-3 px-6 bg-ogm-green-600 text-white rounded-lg font-semibold hover:bg-ogm-green-700 transition-colors disabled:bg-slate-300">
